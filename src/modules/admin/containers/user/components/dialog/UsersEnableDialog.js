...
import {enableUsers, fetchUsers} from "../../store/actions"
...
const UsersDisableDialog = ({ show, onHide }) => {
  ...
  const onDisableUsers = () => {
    ...
    dispatch(enableUsers(usersUIProps.ids))
  }
    ...
    >
      ...
      <Modal.Header closeButton>
        <Modal.Title id="example-modal-sizes-title-lg">
          <FormattedMessage id="USER.MULTIPLE_ENABLE.TITLE" />
        </Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <FormattedMessage id="USER.MULTIPLE_ENABLE.MSG" />
      </Modal.Body>
      <Modal.Footer>
        <div>
          <button
