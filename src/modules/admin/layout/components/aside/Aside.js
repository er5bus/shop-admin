...
const Aside = ({ routesMenu }) => {
  ...
  return (
      <>
        {/* begin::Aside */}
        <div id="kt_aside" className={`aside ${layoutProps.asideClassesFromConfig} d-flex flex-column flex-row-auto`}>
          <Brand/>
          {/* begin::Aside Menu */}
          <div id="kt_aside_menu_wrapper" className="aside-menu-wrapper flex-column-fluid">
            ...
            <AsideMenu routesMenu={routesMenu} disableScroll={layoutProps.disableScroll} />
          </div>
          {/* end::Aside Menu */}
        </div>
        {/* end::Aside */}
